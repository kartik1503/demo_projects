...
String sql="SELECT l.lid, e.ename, l.fdate,l.tdate,l.data,l.eid,l.confirmation FROM employee_leave l LEFT JOIN employee_sign e ON e.eid=l.eid where confirmation='process'";
